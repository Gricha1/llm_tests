...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=/mnt/sh/datasets/processed_math/train.parquet \
    data.val_files=['/mnt/sh/datasets/processed_MATH-Hard/test.parquet','/mnt/sh/datasets/processed_MATH-500/test.parquet','/mnt/sh/datasets/processed_aime24/test.parquet','/mnt/sh/datasets/processed_amc23/test.parquet','/mnt/sh/datasets/processed_minerva/test.parquet','/mnt/sh/datasets/processed_olympiadbench/test.parquet']\
    ...
    actor_rollout_ref.model.path=/mnt/sh/models/Qwen__Qwen2.5-Math-1.5B \
