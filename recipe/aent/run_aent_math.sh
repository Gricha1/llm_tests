...
python3 -m recipe.aent.main_aent \
    ...
    data.val_files=['datasets/processed_MATH-Hard/test.parquet','datasets/processed_MATH-500/test.parquet','datasets/processed_aime24/test.parquet','datasets/processed_amc23/test.parquet','datasets/processed_minerva/test.parquet','datasets/processed_olympiadbench/test.parquet']\
